"""LLMリランク (gpt-5.4, detailed prompt with explicit romaji note, small dataset) による評価を実行するスクリプト"""
...
MODEL_NAME = "gpt-5.4"
VOWEL_RATIO = 0.5
PROMPT_TEMPLATE = "detailed_romaji_explicit"
...
def main():
    ...
    output_path = output_dir / "008_05_llm_rerank_gpt54_detailed_pyopenjtalk_romaji_explicit.json"
